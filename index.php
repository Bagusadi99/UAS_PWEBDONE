...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <b><a class="nav-link text-dark" href="order.php">History</a></b>
                    </li>
                </ul>
                ...
                <?php
                    if (isset($_SESSION['id_customer'])) {
                        ...
                        echo '<a href="logout.php" class="btn btn-secondary mr-3 text-white">Halooo '.$nama.'!</a>';
    ...
    <div class="fixed-footer bg-dark">
      <div class="container">Copyright &copy; 2024  <a href="https://www.instagram.com/adibagusptr?igsh=MWY2cmRjOTFvcWRvYg%3D%3D&utm_source=qr" target="_blank">Kelompok 2</a>.</div>
    </div>
